...
// const aaplSplit = fs.readFileSync('./nvda/nvda split.csv', 'utf8');
// const aaplDividend = fs.readFileSync('./nvda/nvda dividend.csv', 'utf8');
const ONE_DAY = 1000 * 60 * 60 * 24;

csvParse(nvda, { auto_parse: true, auto_parse_date: true, columns: true }, (aaplErr, result) => {
